...
if __name__ == '__main__':
    ...
    model_directory1 = './models/train_CSR/'  # directory to save trained model to.
    model_directory = './models/train_CSR'  # directory to save trained model to.
    ...
    with tf.Session() as sess:
        ...
        for i in range(40001, iterations):
